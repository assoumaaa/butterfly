			...
			<div className="flex flex-col space-y-2">
				<div className="flex items-center space-x-2">
					...
					<button
						...
						onClick={() =>
							handlePositionChange("front", 0, snap.frontLogoPosition[0] - 0.01)
						}
					>
						-
					</button>
				...
				<div className="flex items-center space-x-2">
					...
					<button
						className="border border-gray-300 rounded-md p-2"
						onClick={() =>
							handlePositionChange("front", 1, snap.frontLogoPosition[1] - 0.01)
						}
					>
						-
					</button>
				...
				<div className="flex items-center space-x-2">
					...
					<button
						className="border border-gray-300 rounded-md p-2"
						onClick={() =>
							handlePositionChange("front", 2, snap.frontLogoPosition[2] - 0.01)
						}
					>
						-
					</button>
				...
				<div className="flex items-center space-x-2">
					...
					<button
						className="border border-gray-300 rounded-md p-2"
						onClick={() =>
							handleScaleChange("front", snap.frontLogoScale - 0.01)
						}
					>
						-
					</button>
			...
			<div className="flex flex-col space-y-2 mt-4">
				<div className="flex items-center space-x-2">
					...
					<button
						className="border border-gray-300 rounded-md p-2"
						onClick={() =>
							handlePositionChange("back", 0, snap.backLogoPosition[0] - 0.01)
						}
					>
						-
					</button>
				...
				<div className="flex items-center space-x-2">
					...
					<button
						className="border border-gray-300 rounded-md p-2"
						onClick={() =>
							handlePositionChange("back", 1, snap.backLogoPosition[1] - 0.01)
						}
					>
						-
					</button>
				...
				<div className="flex items-center space-x-2">
					...
					<button
						className="border border-gray-300 rounded-md p-2"
						onClick={() =>
							handlePositionChange("back", 2, snap.backLogoPosition[2] - 0.01)
						}
					>
						-
					</button>
